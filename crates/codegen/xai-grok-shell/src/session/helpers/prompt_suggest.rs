...
/// prediction.
pub(crate) const DEFAULT_SUGGEST_MODEL: &str = "gpt-5.6-luna";
...
/// (`gpt-5.6-luna`) is bundled in this fork. Any unavailable pin would send a
/// doomed per-turn request
...
mod tests {
    ...
    fn effective_model_default_requires_catalog() {
        ...
        // A catalog that excludes the default skips the request entirely,
